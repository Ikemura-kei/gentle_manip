...
def main():
    ...
    frag = [
        ...
        'metrics. <b>In-domain (8 cats):</b> success rate <b>0.59 vs 0.47</b>, gentleness '
        '<b>0.78 vs 0.76</b>. <b>OOD zero-shot (blackberry, scallop):</b> SR <b>0.74 vs 0.68</b>, '
        ...
        'tomato/raspberry) &mdash; a sim-fidelity limit at that scale (tomato re-added after '
        'fixing an MPM instability that had it explode on contact).</span></div>',
