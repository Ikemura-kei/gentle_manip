...
class PolicyEnv:
    ...
    def __init__(
        ...
        # Absolute pose + DELTA gripper: the backend must ACCUMULATE the gripper dim instead of
        # setting it. Pushed the same way as rate_limit so sim and real stay identical.
